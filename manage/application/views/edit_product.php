                             ...
                             <div class="text-start">
                                 <div class="p-20">
                                     <form class="row g-3 needs-validation" novalidate=""
                                         action="<?php echo base_url()?>product/updateproduct" method="post"
                                         enctype="multipart/form-data">
                                         <div class="col-md-6">
                                            <input name="productid" id="productid" type="hidden" required="" value="<?php echo $productlist->product_id;?>">
                                             ...
                                             <input class="form-control" name="productname" id="productname" type="text"
                                                 placeholder="Enter your product name" required="" value="<?php echo $productlist->product_title;?>">
                                         ...
                                         <div class="col-md-6">
                                             ...
                                             <input class="form-control" id="productslug" type="text"
                                                 placeholder="Enter product slug" name="productslug" value="<?php echo $productlist->product_slug;?>">
                                             <div class="invalid-feedback">
                                         ...
                                         <div class="col-md-6">
                                             ...
                                             <input class="form-control" id="productsku" type="text"
                                                 placeholder="Enter product slug" name="productsku" value="<?php echo $productlist->product_sku;?>">
                                             <div class="invalid-feedback">
                                         ...
                                         <div class="col-md-12">
                                             ...
                                             <textarea id="editor1" class="form-control" name="product_desc" cols="30"
                                                 rows="5"><?php echo $productlist->product_description;?></textarea>
                                         </div>
                                         <div class="col-md-6">
                                             ...
                                             <select class="form-select" name="productstatus"
                                                 ...
                                                 <option value="1" <?php if($productlist->isActive == 1) { echo "selected";} ?>>Active</option>
                                                 <option value="0" <?php if($productlist->isActive == 0) { echo "selected";} ?>>Inactive</option>
                                             </select>
                                             <div class="invalid-feedback">
