                     ...
                     <div class="card">
                         <div class="card-body">
                             <div class="list-product-header">
                                 <div>
                                    <a class="btn btn-primary f-w-500" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#dashboard8"><i class="fa fa-plus pe-2"></i>Add Category</a>
                                 </div>
                                     ...
                                     <tbody>
                                        <?php if(count($categorylist)){
                                            ...
                                            <tr class="product-removes">
                                             ...
                                             <td>
                                                 <div class="product-names">
                                                     <p><?php if($row->isActive == 0) { echo 'Active'; } else { echo 'Inactive'; };?></p>
                                                 </div>
                                             </td>
                                            <td>
                                             <ul class="action"> 
                                                    <li class="edit"> <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#editdashboard8" onclick=edit_category(<?php echo $row->id;?>)><i class="icon-pencil-alt"></i></a></li>
                                                    <li class="delete"><a href="<?php echo base_url()?>category_master/changestatus/<?php echo $row->isActive;?>/<?php echo $row->id;?>" ><i class="fa fa-undo" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Change Status Active Or Inactive"></i></a></li>
                                                </ul>
                                             </td>
                                         </tr>
                             ...
                             <div class="modal-content category-popup">
                                 ...
                                 <div class="modal-body p-0 custom-input">
                                     <div class="text-start">
                                         <div class="p-20">
                                             <form class="row g-3 needs-validation" novalidate="" action="<?php echo base_url()?>category_master/addCategory" method="post">
                                                 <div class="col-md-6">
                         ...
                         <div class="modal-dialog modal-dialog-centered modal-lg">
                             <div class="modal-content category-popup">
                                 ...
                                 <div class="modal-body p-0 custom-input">
                                     <div class="text-start">
                                         <div class="p-20">
                                             <form class="row g-3 needs-validation" novalidate="" action="<?php echo base_url()?>category_master/updatecategory" method="post">
                                                 <div class="col-md-6">
                                                    <input type="hidden" name="edit_id" id="edit_id">
                                                     <label class="form-label" for="e_CategoryName">Category
                                                         Name<span class="txt-danger">*</span></label>
                                                     <input class="form-control" name="e_categoryname" id="e_CategoryName" type="text"
                                                         placeholder="Enter your category name" required="">
                                                     <div class="invalid-feedback">
                                                         Please enter a category name.</div>
                                                     <div class="valid-feedback">Looks good!</div>
