              ...
              <div class="col-xxl-10 col-md-12 box-col-8 grid-ed-12">
                <div class="row">
                      ...
                      <div class="col-sm-12"> 
                        <div class="card o-hidden">             
                          <div class="card-body balance-widget"><span class="f-w-500 f-light">Total Balance</span>
                            ...
                            <div class="mobile-right-img"><img class="left-mobile-img" src="<?php echo base_url()?>assets/images/dashboard-2/widget-img.png" alt=""><img class="mobile-img" src="<?php echo base_url()?>assets/images/dashboard-2/mobile.gif" alt="mobile with coin"></div>
                          </div>
                        </div>
                      </div>
                      <div class="col-6"> 
                          ...
                          <div class="card-body primary"> <span class="f-light">New Orders</span>
                            ...
                            <div class="bg-gradient"> 
                              <svg class="stroke-icon svg-fill">
                                <use href="<?php echo base_url()?>assets/svg/icon-sprite.svg#new-order"></use>
                              </svg>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-6"> 
                        <div class="card small-widget"> 
                          <div class="card-body warning"><span class="f-light">New Customers</span>
                            ...
                            <div class="bg-gradient"> 
                              <svg class="stroke-icon svg-fill">
                                <use href="<?php echo base_url()?>assets/svg/icon-sprite.svg#customers"></use>
                              </svg>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-6"> 
                        <div class="card small-widget"> 
                          <div class="card-body secondary"><span class="f-light">Average Sale</span>
                            ...
                            <div class="bg-gradient"> 
                              <svg class="stroke-icon svg-fill">
                                <use href="<?php echo base_url()?>assets/svg/icon-sprite.svg#sale"></use>
                              </svg>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-6"> 
                        <div class="card small-widget"> 
                          <div class="card-body success"><span class="f-light">Gross Profit</span>
                            ...
                            <div class="bg-gradient"> 
                              <svg class="stroke-icon svg-fill">
                                <use href="<?php echo base_url()?>assets/svg/icon-sprite.svg#profit"></use>
                              </svg>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="card-body pt-0">
                          <div class="appointment-table customer-table table-responsive">
                            <table class="table table-bordernone">
                              <tbody>
                                <tr>
                                  <td><img class="img-fluid img-40 rounded-circle me-2" src="<?php echo base_url()?>assets/images/dashboard/user/1.jpg" alt="user"></td>
                                ...
                                <tr>
                                  <td><img class="img-fluid img-40 rounded-circle me-2" src="<?php echo base_url()?>assets/images/dashboard/user/2.jpg" alt="user"></td>
                                ...
                                <tr>
                                  <td><img class="img-fluid img-40 rounded-circle me-2" src="<?php echo base_url()?>assets/images/dashboard/user/9.jpg" alt="user"></td>
                                ...
                                <tr>
                                  <td><img class="img-fluid img-40 rounded-circle me-2" src="<?php echo base_url()?>assets/images/dashboard/user/5.jpg" alt="user"></td>
                                ...
                                <tr>
                                  <td><img class="img-fluid img-40 rounded-circle me-2" src="<?php echo base_url()?>assets/images/dashboard/user/3.jpg" alt="user"></td>
                            ...
                            <div class="row g-sm-3 g-2">
                              <div class="col-md-12">
                                <div class="light-card balance-card widget-hover">
                                  <div class="svg-box">
                                    <svg class="svg-fill">
                                      <use href="<?php echo base_url()?>assets/svg/icon-sprite.svg#orders"></use>
                                    </svg>
                                  </div>
                  ...
                  <div class="col-xxl-3 col-xl-4 col-sm-6 box-col-6 wow zoomIn">
                    <div class="card purchase-card discover"><img class="img-fluid" src="<?php echo base_url()?>assets/images/dashboard-2/discover.png" alt="vector discover">
                        ...
                        <div class="header-top">
                          <h5 class="m-0">Visitors<span class="f-14 font-primary f-w-500 ms-1">
                              <svg class="svg-fill me-1">
                                <use href="<?php echo base_url()?>assets/svg/icon-sprite.svg#user-visitor"></use>
                              </svg>(+2.8)</span></h5>
                          <div class="card-header-right-icon">
                            <div class="dropdown icon-dropdown">
                      ...
                      <div class="card-body pt-0"> 
                        <div class="recent-sliders">
                          <div class="nav nav-pills" id="v-pills-tab" role="tablist">
                            <button class="active frame-box" id="v-pills-shirt-tab" data-bs-toggle="pill" data-bs-target="#v-pills-shirt" type="button" role="tab" aria-controls="v-pills-shirt" aria-selected="true"><span class="frame-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/1.png" alt="vector T-shirt"></span></button>
                            <button class="frame-box" id="v-pills-television-tab" data-bs-toggle="pill" data-bs-target="#v-pills-television" type="button" role="tab" aria-controls="v-pills-television" aria-selected="false"><span class="frame-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/2.png" alt="vector television"></span></button>
                            <button class="frame-box" id="v-pills-headphone-tab" data-bs-toggle="pill" data-bs-target="#v-pills-headphone" type="button" role="tab" aria-controls="v-pills-headphone" aria-selected="false"><span class="frame-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/3.png" alt="vector headphone"></span></button>
                            <button class="frame-box" id="v-pills-chair-tab" data-bs-toggle="pill" data-bs-target="#v-pills-chair" type="button" role="tab" aria-controls="v-pills-chair" aria-selected="false"><span class="frame-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/4.png" alt="vector chair"></span></button>
                            <button class="frame-box" id="v-pills-lamp-tab" data-bs-toggle="pill" data-bs-target="#v-pills-lamp" type="button" role="tab" aria-controls="v-pills-lamp" aria-selected="false"><span class="frame-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/5.png" alt="vector lamp"></span></button>
                          </div>
                                ...
                                <table class="table"> 
                                  ...
                                  <tbody> 
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/4.png" alt="t-shirt"></div>
                                          <div> 
                                      ...
                                      <td class="f-w-500">
                                        <div class="recent-status font-success"> 
                                          <svg class="me-1">
                                            <use href="<?php echo base_url()?>assets/svg/icon-sprite.svg#24-hour"> </use>
                                          </svg>Verified
                                        </div>
                                      </td>
                                    ...
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/3.png" alt="t-shirt"></div>
                                          <div> 
                                ...
                                <table class="table"> 
                                  ...
                                  <tbody> 
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/5.png" alt="television"></div>
                                          <div> 
                                    ...
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/6.png" alt="television"></div>
                                          <div> 
                                ...
                                <table class="table"> 
                                  ...
                                  <tbody> 
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/1.png" alt="headephones"></div>
                                          <div> 
                                            <h6 class="f-14 mb-0"><a href="order-history.html">Sony</a></h6><span class="f-light f-12">Id : #CFDE-2163</span>
                                          </div>
                                        </div>
                                    ...
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/2.png" alt="headephones"></div>
                                          <div> 
                                ...
                                <table class="table"> 
                                  ...
                                  <tbody> 
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/7.png" alt="chair"></div>
                                          <div> 
                                    ...
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/8.png" alt="chair"></div>
                                          <div> 
                                ...
                                <table class="table"> 
                                  ...
                                  <tbody> 
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/9.png" alt="lamp"></div>
                                          <div> 
                                    ...
                                    <tr> 
                                      <td>
                                        <div class="product-content">
                                          <div class="order-image"><img src="<?php echo base_url()?>assets/images/dashboard-2/order/sub-product/10.png" alt="lamp"></div>
                                          <div> 
                ...
                <div class="card">
                  ...
                  <div class="card-body pt-0"> 
                    <ul class="categories-list">
                      <li class="d-flex"> 
                        <div class="bg-light"> <img src="<?php echo base_url()?>assets/images/dashboard-2/category/1.png" alt="vector burger"></div>
                        <div> 
                          <h6 class="mb-0"><a href="product.html">Food & Drinks</a></h6><span class="f-light f-12 f-w-500">(12,200)</span>
                        </div>
                      </li>
                      <li class="d-flex"> 
                        <div class="bg-light"> <img src="<?php echo base_url()?>assets/images/dashboard-2/category/2.png" alt="vector furniture"></div>
                        <div> 
                          <h6 class="mb-0"><a href="product.html">Furniture</a></h6><span class="f-light f-12 f-w-500">(7,510)</span>
                        </div>
                      </li>
                      <li class="d-flex"> 
                        <div class="bg-light"> <img src="<?php echo base_url()?>assets/images/dashboard-2/category/3.png" alt="vector grocery box"></div>
                        <div> 
                          <h6 class="mb-0"><a href="product.html">Grocery</a></h6><span class="f-light f-12 f-w-500">(15,475)</span>
                        </div>
                      </li>
                      <li class="d-flex"> 
                        <div class="bg-light"> <img src="<?php echo base_url()?>assets/images/dashboard-2/category/4.png" alt="vector game remote"></div>
                        <div> 
                          <h6 class="mb-0"><a href="product.html">Electronics</a></h6><span class="f-light f-12 f-w-500">(27,840)</span>
                        </div>
                      </li>
                      <li class="d-flex"> 
                        <div class="bg-light"> <img src="<?php echo base_url()?>assets/images/dashboard-2/category/5.png" alt="vector toys"></div>
                        <div> 
                          <h6 class="mb-0"><a href="product.html">Toys & Games</a></h6><span class="f-light f-12 f-w-500">(8,788)</span>
                        </div>
                      </li>
                      <li class="d-flex"> 
                        <div class="bg-light"> <img src="<?php echo base_url()?>assets/images/dashboard-2/category/6.png" alt="vector monitor"></div>
                        <div> 
                          <h6 class="mb-0"><a href="product.html">Desktop</a></h6><span class="f-light f-12 f-w-500">(10,673)</span>
                        </div>
                      </li>
                      <li class="d-flex"> 
                        <div class="bg-light"> <img src="<?php echo base_url()?>assets/images/dashboard-2/category/7.png" alt="vector mobile"></div>
                        <div> 
                        ...
                        <li class="d-flex">
                          ...
                          <div class="w-100 ms-3">
                            ...
                            <div class="recent-images"> 
                              <ul> 
                                <li> 
                                  <div class="recent-img-wrap"><img src="<?php echo base_url()?>assets/images/dashboard-2/product/1.png" alt="chair"></div>
                                </li>
                                <li> 
                                  <div class="recent-img-wrap"><img src="<?php echo base_url()?>assets/images/dashboard-2/product/2.png" alt="chair"></div>
                                </li>
                                <li> 
                                  <div class="recent-img-wrap"><img src="<?php echo base_url()?>assets/images/dashboard-2/product/3.png" alt="men t-shirt"></div>
                                </li>
                              </ul>
                            </div>
                          </div>
