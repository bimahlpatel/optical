                 ...
                 <div class="row">
                     ...
                     <div class="col-6">
                         <ol class="breadcrumb">
                             ...
                             <li class="breadcrumb-item">Contact Product</li>
                             <li class="breadcrumb-item active">Add Leses Product</li>
                         </ol>
                     </div>
                 </div>
             </div>
                             ...
                             <div class="text-start">
                                 <div class="p-20">
                                     <form class="row g-3 needs-validation" novalidate=""
                                         action="<?php echo base_url()?>contact_lenses/insert_lense_product" method="post"
                                         ...
                                         <div class="col-md-6">
                                             <label class="form-label">Leses Category<span
                                                     class="txt-danger">*</span></label>
                                             <select class="form-select" id="lensecategory" name="lensecategory"
                                                 aria-label="Select Leses category" required="">
                                                 <option value="">Select</option>
                                                 <?php foreach($lensecategory as $cat){?>
                                                 <option value="<?php echo $cat->lense_cat_id;?>">
                                                     <?php echo $cat->lense_cat_name;?></option>
                                                 <?php } ?>
                                             </select>
                                             <div class="invalid-feedback">
                                         ...
                                         <div class="col-md-6">
                                             <label class="form-label">Product SubCategory<span
                                                     class="txt-danger">*</span></label>
                                             <select class="form-select" id="lensesubcategory" name="lensesubcategory" aria-label="Select product Subcategory" required="">
                                                 <option value="">Select</option>
                                                 
                                             </select>
                                             <div class="invalid-feedback">
                                                 Please choose a lenses subcategory.</div>
                                             <div class="valid-feedback">Looks good!</div>
                                         </div>
                                         <div class="col-12">
...
$('#lensecategory').on('change', function(){
      var catid = $(this).val();

      $.ajax({
          url : "<?php echo site_url('contact_lenses/getlesnse_subcategory/'); ?>" + catid,
          type:'POST',
          dataType: 'json',
          cache: false,
          processData: false,
          success: function(response) {
              $("#lensesubcategory").find('option').remove();
              if(response['success'] == true) {
                  $("#lensesubcategory").append(response['lenses_subcategorylist']);
              } 
           }
      });
  });
